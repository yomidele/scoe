...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SCOE Pambula Michika — Result Portal" },
      { name: "twitter:title", content: "SCOE Pambula Michika — Result Portal" },
      { property: "og:description", content: "Shallom College of Education, Pambula Michika — demo result management portal" },
      { name: "twitter:description", content: "Shallom College of Education, Pambula Michika — demo result management portal" },
